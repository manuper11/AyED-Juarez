...
Cristal FusionadorEnergon::fusionar_cristal(Cristal cristal_1, Cristal cristal_2, Rareza nueva_rareza) {
    ...
    cristal_resultante.set_estadistica_fuerza((cristal_1.get_estadistica_fuerza() + cristal_2.get_estadistica_fuerza())*FACTOR_FUSION_EXITOSA);
    cristal_resultante.set_estadistica_velocidad((cristal_1.get_estadistica_velocidad() + cristal_2.get_estadistica_velocidad())*FACTOR_FUSION_EXITOSA);
    cristal_resultante.set_estadistica_defensa((cristal_1.get_estadistica_defensa() + cristal_2.get_estadistica_defensa())*FACTOR_FUSION_EXITOSA);
    return cristal_resultante;
}
